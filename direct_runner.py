...
# Try to import tarfile, should be part of standard library
try:
    import tarfile
except ImportError:
    print("Error: tarfile module not available")
    sys.exit(1)
...
def main():
    ...
    print(f"{CYAN}               Python Edition for Jupyter Notebooks{RESET_COLOR}")
    print(f"{WHITE}{'='*70}{RESET_COLOR}")
